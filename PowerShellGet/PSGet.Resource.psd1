...
###PSLOC
        ...
        LicensUriNotSpecified=License Uri is not specified. License Uri is required for user license acceptance.
        LicensTxtNotFound=License.txt not Found. License.txt is required for user license acceptance.
