...
function SuiteSetup {
    ...
    if ((Get-Module PKI -ListAvailable)) {
        ...
        write-host $alice1Cert
        write-host $alice2Cert
        write-host $bobCert
...
Describe PowerShell.PSGet.InstallModuleTests -Tags 'BVT','InnerLoop' {
    ...
    It 'InstallNonMsSignedModuleOverNonMsSignedModuleWithSameCertificateSubject' {
        ...
        Install-Module Foo -RequiredVersion 99.99.99.96 -Repository $script:localGalleryName -ErrorVariable iev -WarningVariable iwv #-debug
        ...
        Install-Module Foo -ErrorVariable iev -WarningVariable iwv -Force   #-Debug
